/**
 * Dojo STRATEGY track — the playing course.
 *
 * The judgement half of the dojo, moved over from the original single-track
 * course. It assumes the basics track: every lesson uses the vocabulary of
 * sets and pairs, tenpai and waits, yaku, riichi, calls, dora and furiten
 * without introducing them. New players should start with the basics track.
 *
...
export const STRATEGY_CHAPTERS: Chapter[] = [
  // =========================================================================
  {
    id: 'building-blocks',
    book: 3,
          ...
          ...drills([
            {
              ...
              prompt: 'Either discard leaves you tenpai: 13p waiting on 2p, or 35p waiting on 4p. Three 4p are in the ponds. Which?',
              check: 'efficiency',
              options: [
          ...
          ...drills([
            ...
            },
            {
              ...
              options: [
                ...
                { tile: '6s', why: 'Now 55s and 99p are two pairs waiting shanpon — but count them: all four 9p are on the table or in your hand, and two of the four 5s are yours. A wait that should be eight tiles is really a two-tile wait.' },
    ...
    lessons: [
      {
        ...
        steps: [
          ...
          },
          {
            ...
            text: [
              'Now look at this hand properly. The same run in all three suits — 234m, 234p, 234s — is sanshoku, three han closed, and it is already in the hand: three runs, a pair, and a two-sided wait to finish.',
          ...
          ...drills([
            {
              ...
              check: 'efficiency',
              options: [
                { tile: 'E', correct: true, why: 'The only spare tile in the hand. Throwing it keeps the three identical runs, the head and an eight-tile wait — a three-han yaku that cost nothing, which is the only kind worth having.' },
                ...
                { tile: '8s', why: 'Same mistake at the other end: the sanshoku is worth three han when the hand wins, and not one point when it is still one-shanten next turn.' },
                { tile: '2m', why: 'That is one of the three runs the yaku is made of. Breaking it gives up three han to keep a floater — the trade the rule of thumb forbids.' },
              ],
            },
            {
              turn: 'Turn 8',
        ...
        steps: [
          ...
          ...drills([
            ...
            },
            {
              ...
              options: [
                { label: 'They are on a pin honitsu — hold the 9m and fold', correct: true, why: 'A river of nothing but man tiles for six turns is the loudest tell in the game. Their hand is pin plus honours, so your man tiles are safe against them and any pin tile is not. The 9m is a safe tile — hold it as your escape, not as part of the hand.' },
  ...
  // =========================================================================
  {
    ...
    kanji: '価値',
    blurb: 'Han stack into the ladder and fu fill the gaps — and where the hand sits on the ladder decides what a riichi is really worth.',
    lessons: [
      {
        id: 'han-ladder',
        title: 'Han and the ladder',
        summary: 'Yaku count han and dora pile on top. Below five the fu set the price; from five the tiers do.',
        steps: [
          {
            kind: 'teach',
            turn: 'Turn 9',
            hand: '234m 567m 44p 234s 45s',
            draw: '1m',
            dora: '3p',
            focus: '44p',
            rivers: { 0: '1m 8m 9m 1p 5p 9m 1s 2s', 1: '1p 5p 6p 7p 8p 9p 1s 2s', 2: '7p 8p 9p 3s 5s 7s 8s 9s', 3: '1s 2s 4s 5s 7s 8s E 3p' },
            wall: 36,
            text: [
              'Every yaku on the card is a number of han, and every dora tile in a winning hand adds one more. This hand is pinfu and tanyao — two han before the dora — and the 3p indicator makes the 4p dora, so the pair of 4p adds two: four han.',
              'The han, not the shape, set the price: two hands with the same han and fu pay the same whatever they look like. Count the han first, work out the fu later, and do not chase a yaku you do not need.',
            ],
            figures: [
              { tiles: '234m 567m 44p 234s 456s', caption: 'Won on the 6s: Pinfu (1 han), Tanyao (1 han) and the dora line for the two 4p — four han, 30 fu, 7,700 points.' },
            ],
          },
          {
            kind: 'teach',
            ...
            wall: 36,
            text: [
              'Below five han the fu set the exact number: 1 han 30 fu pays 1,000, 2 han 30 fu pays 2,000, 3 han 30 fu pays 3,900, 4 han 30 fu pays 7,700. At five han the fu stop mattering and the hand becomes mangan — 8,000 on a child ron.',
              'And the cap comes early: a 4-han hand with 40 fu or more, or a 3-han hand with 70 fu or more, has already counted to the mangan base, so it is cut to the same 8,000. Above that the ladder runs in tiers — 6-7 han haneman 12,000, 8-10 baiman 16,000, 11-12 sanbaiman 24,000, 13 or more yakuman 32,000 — and inside a tier extra han buy nothing.',
            ],
            note: {
              title: 'The ladder, child ron',
              text: '1 han 30 fu 1,000 · 2 han 30 fu 2,000 · 3 han 30 fu 3,900 · 4 han 30 fu 7,700 · 5+ mangan 8,000 · 6-7 haneman 12,000 · 8-10 baiman 16,000 · 11-12 sanbaiman 24,000 · 13+ yakuman 32,000.',
            },
          },
          ...drills([
            {
              turn: 'Turn 9',
              hand: '123m 456m 789m PPP 8m',
              draw: '1s',
              dora: '9p',
              rivers: { 0: '1p 2p 3p 5p 6p 7p 8p 9p', 1: '1s 2s 4s 5s 7s 8s 9s E', 2: '1s 2s 4s 5s 7s 8s 3p 6p', 3: '1s 2s 4s 5s 7s 8s 9s E' },
              wall: 36,
              table: 'Ittsu, honitsu and the white dragon triplet: six han, on a single 8m wait.',
              prompt: 'This hand wins by ron on a child. What does the loser pay?',
              options: [
                { label: '12,000 — haneman', correct: true, why: 'Six and seven han are haneman: 12,000 on a child ron. The fu stop mattering at five han, and the tier above, baiman, needs eight — so this sixth han has already done its job.' },
                { label: '8,000 — mangan', why: 'Mangan is five han — the floor of the limit, not the ceiling. This hand is six, which is the start of the next tier up: haneman, 12,000.' },
                { label: '16,000 — baiman', why: 'Baiman runs from eight to ten han. Two more han away it jumps to 16,000 — at eight, not at six.' },
              ],
            },
            {
              turn: 'Turn 9',
              ...
              dora: '9m',
              focus: '11m',
              rivers: { 0: '1p 2p 3p 5p 6p 7p 8p 9p', 1: '1s 4s 5s 7s 8s 9s E S', 2: '1s 4s 5s 7s 8s 9s W N', 3: '1s 4s 5s 7s 8s 9s E W' },
              wall: 36,
              table: 'Chinitsu, ittsu, a duplicated 123m run, pinfu and two dora: twelve han when it wins on the 4m.',
              prompt: 'This hand wins by ron on the 4m, on a child. What does the loser pay?',
              options: [
                { label: '24,000 — sanbaiman', correct: true, why: 'Eleven and twelve han are sanbaiman: 24,000 on a child ron. The next step up is the yakuman line at thirteen — the thirteenth han is worth 8,000, the biggest jump on the whole ladder.' },
                { label: '16,000 — baiman', why: 'Baiman runs from eight to ten han; twelve is already off that list. This hand is one han short of the yakuman line, not two steps below baiman.' },
                { label: '32,000 — yakuman', why: 'Yakuman needs thirteen han, or a yakuman pattern. Twelve is counted sanbaiman; the jump to 32,000 comes with the thirteenth han.' },
              ],
            },
            {
              turn: 'Turn 9',
              hand: '234m 567m 789m 234m E',
              draw: '1p',
              dora: '9s',
              seatWind: 'east',
              rivers: { 0: '1p 2p 3p 5p 6p 7p 8p 9p', 1: '1s 2s 4s 5s 7s 8s 9s S', 2: '1s 2s 4s 5s 7s 8s 3p 6p', 3: '1s 2s 4s 5s 7s 8s 9s W' },
              wall: 36,
              table: 'Honitsu, iipeiko and a wind pair: four han, 50 fu, on a single E wait.',
              prompt: 'This hand wins by ron on a child. What does the loser pay?',
              options: [
                { label: '8,000 — cut to mangan', correct: true, why: '50 fu at four han counts to 12,800, but a counted hand that reaches the mangan base is cut to 8,000 — 40 fu at four han is the line. The cap is why 4-han hands are fought over their fu: at 30 fu this hand pays 7,700, still under the line. A riichi would add the fifth han, but the hand is mangan either way — 8,000 both sides.' },
                { label: '12,800 — counted by fu', why: 'That is what 50 fu at four han counts to — until it hits the mangan base and is cut. A counted hand that reaches the 2,000 base becomes mangan, and this one has.' },
                { label: '7,700 — four han', why: '7,700 is four han at 30 fu. This hand has two more fu than that — the single-tile wait and the wind pair earn them — and at 50 fu it is past the mangan base.' },
              ],
            },
          ]),
        ],
      },
      {
        id: 'fu-loosely',
        title: 'Fu, loosely',
        summary: 'Pinfu-shaped hands are cheap and triplet hands are expensive — and the win banner prints the whole calculation.',
        steps: [
          {
            kind: 'teach',
            turn: 'Turn 9',
            hand: '111m 222m 333m 44p 99p',
            draw: '5s',
            dora: '7m',
            focus: '111m 222m 333m',
            rivers: { 0: '1s 2s 4s 5s 7s 8s 9s E', 1: '1p 2p 3p 5p 6p 7p 8p 9p', 2: '1s 2s 4s 5s 7s 8s 3p 6p', 3: '1s 2s 4s 5s 7s 8s 9s E' },
            wall: 36,
            text: [
              'Fu is the fine print of the price. Every hand starts at 20, a closed ron adds 10 (a tsumo adds 2), and then the shape adds on: open triplets 2 each (4 for honours), concealed triplets 4 (8), kansi 8 to 16, every closed wait 10, a yakuhai pair 10 — then round up to the next ten.',
              'That is why pinfu-shaped hands are cheap: four runs and an open wait means no shape fu at all, and the hand stays flat at 20 (30 on a closed ron). Triplet hands are the opposite — this one is toitoi with three concealed triplets, and its fu climb to 60: four han, already mangan before a single dora.',
            ],
            figures: [
              { tiles: '111m 222m 333m 44p 999p', caption: 'Won on the 9p: Toitoi (2 han), Sanankou (2 han). The triplets and the shanpon wait push the fu to 60 — four han, mangan.' },
            ],
            note: {
              title: 'Cheap versus expensive',
              text: 'A pinfu hand wins at 20-30 fu. A hand built of triplets starts at 50 and climbs. Same two han, very different check.',
            },
          },
          {
            kind: 'teach',
            turn: 'Turn 9',
            hand: '345m 678m 44p 567p 78s',
            draw: '1m',
            dora: '3p',
            focus: '44p 78s',
            rivers: { 0: '1m 8m 9m 1p 5p 9m 1s 2s', 1: '1p 5p 6p 7p 8p 9p 1s 2s', 2: '7p 8p 9p 3s 5s 7s 8s 9s', 3: '1s 2s 4s 5s 7s 8s E 3p' },
            wall: 36,
            text: [
              'When the hand wins, the banner reads the arithmetic top to bottom: one line per yaku with its han, then Dora, Red fives and — for a riichi hand — the hidden dora line, each with its count. The bold line is the answer: a limit name like Mangan, or the han and fu, with the points beside it.',
              'If somebody dealt in, it says “Dealt in by” above the lines, because one player pays the whole bill. The card never leaves you guessing: yaku plus dora plus reds is the han, and the bold line is the payment.',
            ],
            figures: [
              { tiles: '345m 678m 44p 567p 678s', caption: 'The card for this win: Pinfu 1 han, Tanyao 1 han, Dora 2 han, and the bold line “4 han 30 fu” with 7,700 pts.' },
            ],
            note: {
              title: 'The bold line',
              text: 'Below five han it reads “N han M fu”; at five and above it reads the limit — Mangan, Haneman, Baiman, Sanbaiman, Yakuman. The points beside it never lie either way.',
            },
          },
          ...drills([
            {
              ...
              rivers: { 0: '1m 8m 9m 1p 5p 9m 1s 2s', 1: '1p 5p 6p 7p 8p 9p 1s 2s', 2: '7p 8p 9p 3s 5s 7s 8s 9s', 3: '1s 2s 4s 5s 7s 8s E 3p' },
              wall: 36,
              table: 'A child ron. The card is on the table — read it.',
              prompt: 'The card shows Pinfu (1), Tanyao (1), Dora (2) and the bold line “4 han 30 fu”. What does the hand pay?',
              options: [
                { label: '7,700', correct: true, why: 'Four han at 30 fu counts to 7,700 — under the mangan base, so the bold line is the han and fu, not a limit. A fifth han is what would flip it to Mangan and 8,000.' },
                { label: '3,900', why: '3,900 is three han at 30 fu. The card says four — the dora line has gone uncounted.' },
                { label: '8,000', why: '8,000 is mangan — five han, or four han at 40 fu or more. The card says four han at 30 fu, which counts to 7,700.' },
              ],
            },
            {
              turn: 'Turn 9',
              ...
              rivers: { 0: '1s 2s 4s 5s 7s 8s 9s E', 1: '1p 2p 3p 5p 6p 7p 8p 9p', 2: '1s 2s 4s 5s 7s 8s 3p 6p', 3: '1s 2s 4s 5s 7s 8s 9s E' },
              wall: 36,
              table: 'Two 2-han hands on paper, both won by ron on a child.',
              prompt: 'Hand A is pinfu, 30 fu. Hand B is 70 fu, the same two han. Which pays more — and how much?',
              options: [
                { label: 'B — 4,500 to 2,000', correct: true, why: 'Below five han the fu are the price: 2 han at 30 fu counts to 2,000, and 2 han at 70 fu to 4,500. Pinfu hands sit at the bottom of that range; kan- and triplet-heavy hands at the top.' },
                { label: 'A — pinfu is the bigger yaku', why: 'Pinfu is a han, not a discount — it keeps the fu low, but both hands hold the same han, so the yaku cancel out. The shape difference is exactly what the fu measure.' },
                { label: 'Both pay 2,000', why: 'The same han is not the same check below the limit: the 40 extra fu in B more than double the payment.' },
              ],
            },
            {
              turn: 'Turn 9',
              ...
              rivers: { 0: '1m 8m 9m 1p 5p 9m 1s 2s', 1: '1p 5p 6p 7p 8p 9p 1s 2s', 2: '7p 8p 9p 3s 5s 7s 8s 9s', 3: '1s 2s 4s 5s 7s 8s E 3p' },
              wall: 36,
              table: 'Two 5-han hands on paper, both won by ron on a child.',
              prompt: 'Hand A wins at 90 fu. Hand B wins at 20 fu. Which pays more?',
              options: [
                { label: 'Both — 8,000', correct: true, why: 'At five han the fu stop counting: both are mangan, 8,000. Fu only matter while the hand is still counted — which is why a pinfu shape is worth its han in a 2-han hand and worth nothing once the hand is mangan.' },
                { label: 'A — 90 fu is 70 more', why: 'Past five han the fu are not added — that is the point of the limit. Both hands pay exactly the same: mangan.' },
                { label: 'B — lower fu is better', why: 'Fu are never a penalty; they can only raise the price below the limit. At five han they stop mattering entirely.' },
              ],
            },
          ]),
        ],
      ...
      {
        id: 'payout-drills',
        title: 'Does riichi change the check?',
        summary: 'The same +1 han nearly doubles a cheap hand, buys mangan for a middle one, and nothing for a big one.',
        steps: [
          {
            kind: 'teach',
            turn: 'Turn 12',
            ...
            dora: '3p',
            focus: '44p',
            rivers: { 0: '1m 8m 9m 1p 5p 9m 1s 2s 4s 7m 3m', 1: '1p 5p 6p 7p 8p 9p 1s 2s 7s 8s 2p', 2: '7p 8p 9p 3s 5s 7s 8s 9s 4m 5m 6m', 3: '1s 2s 4s 5s 7s 8s E 2p 5p 7m 9p' },
            wall: 24,
            text: [
              'Riichi is one han, worth exactly what the ladder says that han is worth. The drills score the same three hands twice — once with the riichi, once without — and the same +1 han does three different jobs: nearly doubles the cheap hand, pushes the middle hand over the mangan line, and buys the big hand nothing at all.',
            ],
          },
          {
            kind: 'teach',
            ...
            wall: 24,
            text: [
              'This hand is the middle case in miniature: pinfu, tanyao and two dora, four han at 30 fu, 7,700. One han below mangan, it is the hand where the riichi decision is worth thinking about — and the two sides of the argument are both about points, not feelings.',
              'For: 7,700 becomes 8,000, plus a bonus han if the hand wins immediately after declaring, plus hidden dora tiles revealed if it wins, plus the pressure that makes opponents throw safe tiles. Against: the wait, the wall, the furiten — the same three questions the riichi chapter asks. The payout is settled here; the judgement is settled there.',
            ],
            note: {
              title: 'Score both ways',
              text: 'Before deciding, ask the question the drills ask: what does the hand pay without the riichi, and what does it pay with it? The difference — not the yaku card — is the decision.',
            },
          },
          ...drills([
            {
              ...
              rivers: { 0: '1m 8m 9m 1p 5p 9m 1s 2s 4s 7m 3m', 1: '1p 5p 6p 7p 8p 9p 1s 2s 7s 8s 2p', 2: '7p 8p 9p 3s 5s 7s 8s 9s 4m 5m 6m', 3: '1s 2s 4s 5s 7s 8s E 2p 5p 7m 9p' },
              wall: 24,
              table: 'Pinfu and tanyao, no dora: 2 han, 30 fu. Tenpai on 6s and 9s.',
              prompt: 'This hand pays 2,000. Declaring riichi makes it 3 han. What does it pay then?',
              options: [
                { label: '3,900', correct: true, why: '3 han 30 fu counts to 3,900: nearly double the 2,000. This is where riichi’s han buys the most — below the first limit, every han nearly doubles the check.' },
                { label: '2,000 — the fu do not change', why: 'The fu stay at 30, yes — but the han moved. At two han the hand counts to 2,000; at three it counts to 3,900.' },
                { label: '8,000 — mangan', why: 'Mangan is five han. Three han at 30 fu is still counted: 3,900, not a limit.' },
              ],
            },
            {
              turn: 'Turn 12',
              ...
              rivers: { 0: '1m 8m 9m 1p 5p 9m 1s 2s 4s 7m 3m', 1: '1p 5p 6p 7p 8p 9p 1s 2s 7s 8s 2p', 2: '7p 8p 9p 3s 5s 7s 8s 9s 4m 5m 6m', 3: '1s 2s 4s 5s 7s 8s E 2p 5p 7m 9p' },
              wall: 24,
              table: 'Pinfu, tanyao and two dora: 4 han, 30 fu. Tenpai on 3s and 6s.',
              prompt: 'This hand pays 7,700. Declaring riichi makes it 5 han. What happens to the check?',
              options: [
                { label: 'It crosses into mangan — 8,000', correct: true, why: 'The fifth han is the limit: 7,700 becomes mangan, 8,000. The gain on the card is small — 300 — but it is the han that buys the floor, and it comes with the early-win bonus, the hidden dora and the pressure on top.' },
                { label: 'It stays 7,700', why: 'No — the fifth han is the limit han. The hand stops being counted and becomes mangan.' },
                { label: 'It doubles — about 15,400', why: 'Doubling is what a han does below three or four han. At four han the hand is already near the ceiling, and mangan caps it at 8,000.' },
              ],
            },
            {
              turn: 'Turn 12',
              hand: '123m 456m 789m 345m 8m',
              draw: '1p',
              dora: '9s',
              rivers: { 0: '1p 5p 6p 7p 8p 9p 1s 2s 3s 4s 5s', 1: '1s 2s 4s 5s 7s 8s 9s E 2p 5p 7p', 2: '1s 2s 4s 5s 7s 8s 9s E 2p 5p 7p', 3: '1s 2s 4s 5s 7s 8s 9s E 3p 6p 8p' },
              wall: 24,
              table: 'Ittsu and chinitsu: 8 han, baiman. A single 8m wait.',
              prompt: 'This hand pays 16,000. Declaring riichi makes it 9 han. What happens to the check?',
              options: [
                { label: 'Nothing — 9 han is still baiman', correct: true, why: 'Baiman runs from eight to ten han, so the ninth han buys nothing on the card. This is the arithmetic behind “the hand is already big”: past the limit, riichi trades the fold for the early-win bonus and the hidden dora — a few hundred at best — not the check.' },
                { label: 'It becomes sanbaiman — 24,000', why: 'Sanbaiman needs eleven han. Nine is still inside the baiman tier, and the check stays at 16,000.' },
                { label: 'It drops — the fu come back', why: 'Limits do not drop when you add a han; you stay in the tier or move up. The ninth han keeps the 16,000.' },
              ],
            },
          ]),
        ],
        ...
        steps: [
          {
            ...
            wall: 49,
            text: [
              'You have just drawn into tenpai. Throw the 1m and you are waiting on 3s and 6s with a closed hand on turn six.',
              'Declare. Riichi is worth far more than the one han printed on the card, because it comes with two bonuses you will keep hearing about. Ippatsu: if your hand wins before your next discard — on the tile you draw, or by ron on a discard thrown in the meantime, with no call by anyone in between — the hand gains an extra han. The window is one go-around, no more. Ura dora: hidden indicators wait in the dead wall, invisible to everyone; if your riichi hand wins, they are revealed in your score and every matching tile in your hand adds a han.',
            ],
            note: {
              title: 'The honest arithmetic',
              text: 'Riichi roughly doubles what an average closed tenpai hand pays on the card — from about a thousand to about two, or two to four thousand — and the ippatsu, the hidden dora and the folds it forces add on top. That is not an edge you can take or leave — it is most of your income.',
            },
          },
          {
            kind: 'teach',
          ...
          ...drills([
            {
              ...
              prompt: 'Discarding 1m gives tenpai on 3s/6s. Riichi or dama?',
              options: [
            ...
            },
            {
              ...
              options: [
                { label: 'Riichi, discarding 9p', correct: true, why: 'Yes. A closed wait feels bad and the arithmetic disagrees: on turn three you have plenty of draws left, all four 5s are live, and the riichi lifts the hand from 1,600 to 2,600 on the card — before the ippatsu, the hidden dora and the pressure. Early riichi on a poor wait still beats late dama on a good one.' },
        ...
        steps: [
          {
            ...
            table: 'Closed, three dora — the indicator makes all three 2m in your hand dora — five han, mangan. Tenpai on 3s and 6s.',
            text: [
              'The exceptions are real but narrow. Learn them as a list and treat anything not on the list as a riichi.',
              'One: the hand is already big — this one, at five han: mangan either way, and the riichi’s han buys nothing on the card. Two: you are furiten. Three: there are no draws left. Four: you are leading in the last hand and want it to end quietly.',
            ],
          },
          {
            kind: 'teach',
          ...
          ...drills([
            ...
            {
              turn: 'Turn 7',
              hand: '234m 567m 44p 234s 56s',
              draw: '1m',
              dora: '3p',
              rivers: { 0: '1m 8m 9m 1p 5p 6p', 1: '1p 5p 6p 7p 8p 9p', 2: '7p 8p 9p 1s 2s 3s', 3: '1s 2s 3s 4s 5s E' },
              wall: 45,
              table: 'The dora indicator makes your pair of 4p dora — two of them. Closed, tenpai on 4s/7s.',
            ...
            {
              turn: 'Turn 10',
              hand: '345m 678m 22p 456p 56s',
              draw: '3m',
              dora: '7s',
              riichi: [3],
              rivers: { 0: '2m 9m 1p 3p 7p 8p 9p 1s 2s', 1: '3p 7p 8p 9p 1s 2s 3s 9s 1m', 2: '9p 1s 2s 3s 4s 5s 6s 5z 1p', 3: '3s 4s 5s 6s 9s E S 9p 4z' },
              wall: 33,
              table: 'The seat to your left is in riichi. Your hand is cheap: no dora, two han — pinfu and tanyao.',
              prompt: 'You reach tenpai into a live riichi with a two-han hand. Declare?',
              options: [
                { label: 'Riichi', correct: true, why: 'Uncomfortable and still right. Your wait is two-sided, you are tenpai, and the riichi lifts the hand from 2,000 to 3,900 — the value that makes pushing worth the danger. Folding a closed tenpai hand because somebody else got there first is how you finish an evening with nothing.' },
        ...
        steps: [
          {
            ...
            text: [
              ...
              'Chapter 3, the building blocks. Chapter 4, the five-block method. Chapter 5, pursuing yaku. Chapter 6, what your hand is worth. Chapter 7, riichi judgement. Chapter 8, defence. Chapter 9, melding.',
            ],
          },
          {
            kind: 'teach',
            ...
            note: {
              ...
              text: 'Chapter 10 (endgame strategy) and the later books. The course covers the book through chapter nine; the book is far more thorough than a phone screen can be wherever it goes further.',
            },
          },
        ],
      },
